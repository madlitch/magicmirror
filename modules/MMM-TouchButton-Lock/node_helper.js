  ...
  runButtonAction: function (moduleId, buttonConfig, buttonId) {
    ...
    if (typeof buttonConfig.notification !== "undefined") {
      if (typeof buttonConfig.payload !== "undefined") {
        this.sendSocketNotification("SEND_NOTIFICATION", {
          moduleId: moduleId,
          notification: buttonConfig.notification,
          payload: buttonConfig.payload
        });
      } else {
        this.sendSocketNotification("SEND_NOTIFICATION", {
          moduleId: moduleId,
  ...
  socketNotificationReceived: function (notification, payload) {
    ...
    if (notification === "CONFIG") {
      ...
      self.runButtonAction(
        payload.moduleId,
        self.configs[payload.moduleId].buttons[payload.id],
        payload.id
      );
    } else {
